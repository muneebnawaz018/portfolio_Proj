...
const Experience = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      current: false,
      points: [
        "Engineered scalable, secure full-stack systems on a React and TypeScript frontend and a .NET Core backend built on layered clean architecture.",
        "Built high-throughput REST APIs with .NET Core middleware, Entity Framework Core, and LINQ, and tuned SQL Server queries, indexing, and stored procedures.",
